    ...
    value: function apply(compiler) {
      ...
      mergeDeep(options, {
        optimization: {
          namedModules: true,
          splitChunks: {
            chunks: (options === null || options === void 0 ? void 0 : (_options$optimization3 = options.optimization) === null || _options$optimization3 === void 0 ? void 0 : (_options$optimization4 = _options$optimization3.splitChunks) === null || _options$optimization4 === void 0 ? void 0 : _options$optimization4.chunks) || 'all',
              ...
              chunk.forEachModule(function (module) {
                if (module.dependencies) {
                  module.dependencies.forEach(function (dependency) {
                    ...
                    try {
                      for (var _iterator = dependencyModuleSet.chunksIterable[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {// console.log('iterated dependency module', module);
